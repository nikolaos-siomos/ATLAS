...
class ConverterSettingsWindow (SettingsWindow):
    ...
    def Build (self):
        ...
        self.sizer.Add ( self.rsonde_delimiter, 1, wx.ALIGN_CENTER_VERTICAL )
        ...
        self.rsonde_format_sizer.AddSpacer(15)
        self.rsonde_format_sizer.AddSpacer(15)
        self.rsonde_format_sizer.AddSpacer(15)
        
        self.rsonde_format_sizer.Add (wx.StaticText ( self.rsonde_format_box, label = "Height data" ), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        self.rsonde_format_sizer.Add ( self.rsonde_format_h_column )
        ...
        self.rsonde_format_sizer.Add ( self.rsonde_format_h_unit, 1, wx.EXPAND )
        
        self.rsonde_format_sizer.Add (wx.StaticText ( self.rsonde_format_box, label = "Pressure data" ), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        self.rsonde_format_sizer.Add ( self.rsonde_format_p_column )
        ...
        self.rsonde_format_sizer.Add ( self.rsonde_format_p_unit, 1, wx.EXPAND )
        
        self.rsonde_format_sizer.Add (wx.StaticText ( self.rsonde_format_box, label = "Temperature data" ), flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        self.rsonde_format_sizer.Add ( self.rsonde_format_t_column, wx.EXPAND )
        ...
        self.rsonde_format_sizer.Add ( self.rsonde_format_t_unit, 1, wx.EXPAND )
        ...
        self.rsonde_format_sizer.Add (self.rsonde_format_rh, flag = wx.ALIGN_CENTER_VERTICAL)
        ...
        self.rsonde_format_sizer.Add ( self.rsonde_format_rh_column )
        ...
        self.rsonde_format_sizer.Add ( self.rsonde_format_rh_unit, 1, wx.EXPAND )
        ...
        self.rsonde_station_sizer.AddSpacer (15)
        ...
        self.rsonde_station_sizer.Add ( self.rsonde_geodata_sizer, 1, flag = wx.EXPAND )
        
        self.rsonde_station_sizer.AddSpacer (5)
        ...
        self.rsonde_station_sizer.Add ( self.rsonde_info_station_name, flag = wx.EXPAND )
        self.rsonde_station_sizer.AddSpacer (5)
        ...
        self.rsonde_station_sizer.Add ( self.rsonde_info_wmo_number, flag = wx.EXPAND )
        self.rsonde_station_sizer.AddSpacer (5)
        ...
        self.rsonde_station_sizer.Add ( self.rsonde_info_wban_number, flag = wx.EXPAND )
        self.rsonde_station_sizer.AddSpacer (5)
