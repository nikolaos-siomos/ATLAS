...
def call_parser():
    ...
    parser.add_argument('--exclude_mode', metavar = 'exclude_mode',
                        ...
                        help = 'Provide all the channel mode types that you want to EXCLUDE (None: None, a: analogue, p: photon). By default the analog signals are excluded for the rayleigh fit ')

    parser.add_argument('--exclude_scattering', metavar = 'exclude_scattering',
                        type = str, nargs = '+', default = ['None'], 
                        help = 'Provide all the channel scattering types that you want to EXCLUDE (None: None, p: co-polar linear analyzer, c: cross-polar linear analyzer, t: total (no depol), o: co-polar circular analyzer, x: cross-polar circular analyzer, v: vibrational Raman, r: rotational Raman, a: Cabannes, f: fluorescence). No scattering type is excluded by default ')

    parser.add_argument('--exclude_subtype', metavar = 'exclude_subtype',
                        type = str, nargs = '+', default = ['w', 'c'], 
