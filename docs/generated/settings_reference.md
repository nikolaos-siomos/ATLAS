...
!!! note "Generated reference"
    This page was generated by ATLAS `1.2.0.rc1` from the parser schema, `src/atlas_actris/templates/settings_template_flavor.py`, and the explicit selection in `src/atlas_actris/templates/template_profiles.py`.
