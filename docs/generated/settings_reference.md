...
!!! note "Generated reference"
    This page was generated by ATLAS `1.0.0` from the parser schema and `src/atlas_actris/templates/settings_template_flavor.py`.
...
| `molecular_mask_window` | Minimum and maximum window size used for molecular-mask tests. | `list[float]` | optional | `0.5, 4.0` | Range: 0.05 to 50.0 | `0.5, 4` | Unchanged from previous ATLAS versions. |
...
| `durbin_watson_threshold` | Accepted Durbin-Watson interval used in the Rayleigh-fit mask. | `list[float]` | optional | `1.0, 3.0` | Range: 0.0 to 4.0 | `1, 3` | Unchanged from previous ATLAS versions. |
...
| `normalization_region` | Height/range interval used for signal normalization. | `list[float]` | optional | `1.5, 2.0` |  | `6, 8` | Unchanged from previous ATLAS versions. |
