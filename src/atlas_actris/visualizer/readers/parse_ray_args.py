...
def call_parser():
    ...
    parser.add_argument('--residual_extinction', metavar = 'residual_extinction',
                        type = float, nargs = '?', default = 10.,
                        help = 'A threshold related to the derivative. It corresponds to the estimated extinction error in Mm^-1 that a slope within the normalization window would introduced. Defaults to: 10.')
