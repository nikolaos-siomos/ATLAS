...
def read_dataset(dir_meas, meas_type = None):
    ...
    if not(os.path.exists(dir_meas)):
        ...
        if len(mfiles) > 0:
            ...
            raw_data = _open_dataset_lazy(mfiles[0])
            ...
            for k in range(len(mfiles)):
                ...
                raw_signal = raw_data.raw_signal.astype(float)
                raw_shots = raw_data.measurement_shots.data
                ...
                sig_f = xr.DataArray(raw_signal.data, 
