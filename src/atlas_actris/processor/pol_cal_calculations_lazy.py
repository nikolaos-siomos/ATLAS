...
def pldr_error(
    ...
    # on partially missing rows. Fully missing rows are masked back to NaN with
    # valid below.
    ...
    sr_max = R.isel(R=idx_max)
    sr_min = R.isel(R=idx_min)
    ...
    min_bsc_ratio = min_bsc_ratio.where(valid)
